...
public class ChatMessage {
    ...
    public ChatMessage(String senderEmail, String friendEmail, String text, String timestamp, String friendId, String friendName, String friendPhoto, String senderId, String senderName, String senderPhoto) {
        this.text = text;
