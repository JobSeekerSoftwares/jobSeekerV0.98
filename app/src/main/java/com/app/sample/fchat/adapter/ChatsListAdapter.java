...
public class ChatsListAdapter extends RecyclerView.Adapter<ChatsListAdapter.ViewHolder> implements Filterable {
    ...
    private OnInfoClickListener2 mOnInfoClickListener;
    ...
    public interface OnInfoClickListener2 {
        void onInfo2Click(View view, ChatMessage obj, int position);
    }

    public void setOnInfoClickListener(final OnInfoClickListener2 mInfoClickListener) {
        this.mOnInfoClickListener = mInfoClickListener;
    }
        ...
        holder.imageB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mOnInfoClickListener != null) {
                    mOnInfoClickListener.onInfo2Click(view, c, position);
                }
            }
        });
