...
public class FriendsListAdapter extends RecyclerView.Adapter<FriendsListAdapter.ViewHolder> implements Filterable {
    ...
    public interface OnInfoClickListener {
        void onInfoClick(View view, Friend obj, int position);
    }
    ...
    public void setOnInfoClickListener(final OnInfoClickListener mInfoClickListener) {
        ...
        holder.imageB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mOnInfoClickListener != null) {
                    mOnInfoClickListener.onInfoClick(view, c, position);
                }
            }
        });
    }
